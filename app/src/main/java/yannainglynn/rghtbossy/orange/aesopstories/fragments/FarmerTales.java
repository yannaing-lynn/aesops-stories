 ...
 */
public class FarmerTales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("လယ္သမားပံုျပင္မ်ား");
        return inflater.inflate(R.layout.fragment_farmer_tales, container, false);

    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.recyclerFarmerTales);
        ...
        mProductList = mDBHelper.getStoriesListByCategory("farmer");
        //Init adapter
