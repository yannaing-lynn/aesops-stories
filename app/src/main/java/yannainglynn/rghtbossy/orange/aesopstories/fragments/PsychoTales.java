 ...
 */
public class PsychoTales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("အေတြးပံုျပင္မ်ား");
        return inflater.inflate(R.layout.fragment_psycho_tales, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.recyclerPsychoTales);
        ...
        mProductList = mDBHelper.getStoriesListByCategory("psycho");
        //Init adapter
